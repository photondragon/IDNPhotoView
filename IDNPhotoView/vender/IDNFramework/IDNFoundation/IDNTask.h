...
+ (id)putTaskWithKey:(id)taskKey group:(id)group request:(NSURLRequest*)request urlTask:(id (^)(NSError*requestError, NSData* responseData, NSURLResponse* response))urlTaskBlock finished:(IDNTaskFinishedBlock)finishedBlock cancelled:(IDNTaskCancelledBlock)cancelledBlock; // designated method
